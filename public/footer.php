        ...
        <div class="media-container-row content mbr-white">
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <p class="mbr-text"><strong>Endereço</strong><br>
                    ...
                    <br>
                    <br>Email: centroclinico@gmail.com &nbsp; Telefone: <?php echo $phone1 ?> <br><?php echo $phone2 ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<br><br></p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <p class="mbr-text">
...
<br>Sábados: de 08h as 12h<br>
            ...
            <div class="col-12 col-md-6">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJp3XCMU2HWZMRvxFr42Flb_E" allowfullscreen=""></iframe></div>
            </div>
        </div>
...
<section once="" class="cid-qAoCPseEUC" id="footer6-c" data-rv-view="664">
        ...
        <div class="media-container-row align-center mbr-white">
            <div class="col-12">
                <p class="mbr-text mb-0 mbr-fonts-style display-7">
                    Centro Clínico Santa Maria - <?php echo Date('Y'); ?><br>Desenvolvido por <a href="https://www.facebook.com/yuri.alexs" target="_blank">Yuri Alexsander</a></p>
            </div>
        </div>
    </div>
</section>
  ...
  <script src="source/web/assets/jquery/jquery.min.js  "></script>
  <script src="source/popper/popper.min.js  "></script>
  <script src="source/tether/tether.min.js  "></script>
  <script src="source/bootstrap/js/bootstrap.min.js  "></script>
  <script src="source/smooth-scroll/smooth-scroll.js  "></script>
  <script src="source/touch-swipe/jquery.touch-swipe.min.js  "></script>
  <script src="source/viewport-checker/jquery.viewportchecker.js  "></script>
  <script src="source/jarallax/jarallax.min.js  "></script>
  <script src="source/data-tables/jquery.data-tables.min.js"></script>
  <script src="source/data-tables/data-tables.bootstrap4.min.js"></script>
  <script src="source/dropdown/js/script.min.js  "></script>
  <script src="source/theme/js/script.js  "></script>
